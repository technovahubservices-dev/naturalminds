  ...
  return (
    <footer className="footer" id="contact">
      <div className="footer-content">
        ...
        <div className="footer-column"><h3>Quick Links</h3>{[["home","Home"],["about","About Us"],["products","Our Breads"],["ingredients","Ingredients"],["quality","Our Promise"],["stores","Find a Store"],["contact","Contact"]].map(([p,t])=><button key={t} onClick={()=>onNavigate(p)}>{t}</button>)}</div>
